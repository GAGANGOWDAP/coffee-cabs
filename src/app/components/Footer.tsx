          ...
          <div className="border-t border-[rgba(247,243,236,0.18)] pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#D8D2C8]">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-[#B86F52] text-white flex items-center justify-center hover:bg-[#F7F3EC] hover:text-[#23483A] transition-all shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#B86F52]"
