      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-14">
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div className="col-span-2 sm:col-span-1">
            ...
            <div className="space-y-2 text-xs text-[#AEB7C2]">
              <a href="tel:+917676726209" className="flex items-center gap-2 hover:text-[#C6A15B] transition-colors">
                <Phone size={13} className="text-[#C6A15B]" /> +91 76767 26209
              </a>
              <a href="mailto:info@coffeecabs.in" className="flex items-center gap-2 hover:text-[#C6A15B] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-[#AEB7C2]">
              ...
              <li>
                <Link to="/pricing" className="hover:text-[#C6A15B] transition-colors">
                  Fleet Tariff & Terms
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-[#AEB7C2]">
              <li>
                <Link to="/packages/mysore" className="hover:text-[#C6A15B] transition-colors">
                  Bangalore to Mysore
                </Link>
              </li>
              <li>
                <Link to="/packages/coorg" className="hover:text-[#C6A15B] transition-colors">
                  Bangalore to Coorg
                </Link>
              </li>
              <li>
                <Link to="/packages/ooty" className="hover:text-[#C6A15B] transition-colors">
                  Bangalore to Ooty
                </Link>
              </li>
              <li>
                <Link to="/packages/goa" className="hover:text-[#C6A15B] transition-colors">
                  Bangalore to Goa
                </Link>
              </li>
              <li>
                <Link to="/booking" className="text-[#C6A15B] font-bold hover:underline">
                  Booking & Enquiry →
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-[#AEB7C2]">
              ...
              <li>
                <Link to="/booking" className="hover:text-[#C6A15B] transition-colors">
                  Book Enquiry
                </Link>
              </li>
              <li>
