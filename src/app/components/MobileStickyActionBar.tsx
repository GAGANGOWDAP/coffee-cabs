  ...
  return (
    ...
    >
      <div className="grid grid-cols-3 gap-2 items-center max-w-md mx-auto">
        ...
        >
          <Phone size={18} className="text-[#23483A] shrink-0" />
        ...
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="#23483A" stroke="none" className="shrink-0">
        ...
        <Link
          to="/booking"
          className="flex flex-col sm:flex-row items-center justify-center gap-1.5 py-2.5 px-2 bg-[#4A3025] text-white rounded-xl font-bold shadow-sm hover:bg-[#23483A] transition-all min-h-[48px] active:scale-95 focus-visible:outline-2 focus-visible:outline-[#23483A]"
