        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-8">
          <div className="grid lg:grid-cols-[1fr_1.8fr] gap-8 items-start">
            ...
            <div className="space-y-4">
              <h2 className="text-xl font-bold text-[#4A3025] mb-4">Direct Contact Channels</h2>

              <a
                href="tel:+917676726209"
                className="flex items-center gap-4 p-5 bg-[#FFFFFF] rounded-2xl border border-[#DDD5C8] hover:border-[#23483A] transition-all shadow-sm"
              >
                <div className="w-12 h-12 rounded-xl bg-[#F7F3EC] text-[#23483A] flex items-center justify-center shrink-0 border border-[#DDD5C8]">
                  <Phone size={20} />
                </div>
                <div>
                  <div className="text-[10px] text-[#6F6A63] font-semibold uppercase tracking-wider">Phone Hotline</div>
                  <div className="text-sm font-bold text-[#252525]">+91 76767 26209</div>
                </div>
              </a>
              ...
              <a
                ...
                className="flex items-center gap-4 p-5 bg-[#FFFFFF] rounded-2xl border border-[#DDD5C8] hover:border-[#23483A] transition-all shadow-sm"
              >
                <div className="w-12 h-12 rounded-xl bg-[#23483A] text-white flex items-center justify-center shrink-0 shadow-sm">
                ...
                <div>
                  <div className="text-[10px] text-[#23483A] font-semibold uppercase tracking-wider">WhatsApp Instant Chat</div>
                  <div className="text-sm font-bold text-[#252525]">Message +91 76767 26209</div>
                </div>
              </a>

              <div className="flex items-center gap-4 p-5 bg-[#FFFFFF] rounded-2xl border border-[#DDD5C8] shadow-sm">
                <div className="w-12 h-12 rounded-xl bg-[#F7F3EC] text-[#23483A] flex items-center justify-center shrink-0 border border-[#DDD5C8]">
                  <Mail size={20} />
                </div>
                <div>
                  <div className="text-[10px] text-[#6F6A63] font-semibold uppercase tracking-wider">Email Inquiry</div>
                  <div className="text-sm font-bold text-[#252525]">info@coffeecabs.in</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-5 bg-[#FFFFFF] rounded-2xl border border-[#DDD5C8] shadow-sm">
                ...
                <div>
                  <div className="text-[10px] text-[#6F6A63] font-semibold uppercase tracking-wider">Headquarters</div>
                  <div className="text-sm font-bold text-[#252525]">Bangalore, Karnataka</div>
                </div>
              </div>
            </div>
